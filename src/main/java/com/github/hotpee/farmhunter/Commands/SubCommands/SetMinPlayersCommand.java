...
public class SetMinPlayersCommand extends SubCommand {
    ...
    public void onCommand(Player player, String[] args) {
        ...
        try {
            ...
            sec.set("minPlayers", Integer.valueOf(args[2]));
            try {
        ...
        Util.Message(player, ConfigManager.getPrefix() + ConfigManager.getMinPlayerSetUp().replaceAll("<0>", String.valueOf(args[2])));
    }

    @Override
    public String name() {
        return FarmHunter.getIns().commandManager.setMinPlayers;
    }
