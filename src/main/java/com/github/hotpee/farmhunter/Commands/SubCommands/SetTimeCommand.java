...
public class SetTimeCommand extends SubCommand {
    ...
    public void onCommand(Player player, String[] args) {
        ...
        try {
            ...
            sec.set("time", Integer.valueOf(args[2]));
            try {
        ...
        Util.Message(player, ConfigManager.getPrefix() + ConfigManager.getTimeSetUp().replaceAll("<0>", String.valueOf(args[2])));
    }

    @Override
    public String name() {
        return FarmHunter.getIns().commandManager.setTime;
    }
