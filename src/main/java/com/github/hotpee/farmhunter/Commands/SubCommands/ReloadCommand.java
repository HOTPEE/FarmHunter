...
public class ReloadCommand extends SubCommand {
    ...
    public void onCommand(Player player, String[] args) {
        ...
        Util.Message(player, ConfigManager.getPrefix() + ConfigManager.getPluginReloaded());
        FarmHunter.getIns().reloadConfig();
    }

    @Override
    public String name() {
        return FarmHunter.getIns().commandManager.reload;
    }
