package com.github.hotpee.farmhunter.Metrics;
...
public class Metrics_cStats {
     ...
     */
    public Metrics_cStats(Plugin plugin) {
        if (plugin == null) {
        ...
        if (enabled) {
            ...
            Bukkit.getServicesManager().register(Metrics_cStats.class, this, plugin, ServicePriority.Normal);
            if (!found) {
                // We are the first!
                startSubmitting();
            }
